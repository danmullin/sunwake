...
- **Web scenes (2026-08-03):** Night Drive + **Rain Drive** (storm cousin — cloudy overcast, wet asphalt, drum lightning) + **Tunnel** (rib lights + bass pulse rings) + **Arcade** (CRT bezel, scanlines, vector starfield, coin-op EQ chrome) + **Skyline** (side-view highway/skyline strip). Skyline / Tunnel / Arcade are **web-first** — bake into mobile only after they feel ready on Pages. Rain Drive ships with the Night Drive family (same Effects panel).
